...
$if not setglobal build $setglobal build 1.0
...
Scalar
    ...
    fconst("ricestraw","post")   = limit*fconst("ricestraw","ante");
    fconst("wheatstraw","post")  = limit*fconst("wheatstraw","ante");
    fconst("potatovines","post") = limit*fconst("potatovines","ante");
...
Set
    z CP demand level /low, mid, high/
